...
double Kp1 = 150, Ki1 = 5, Kd1 = 0.02;  //Adjust the PID to fit the motor
...
void loop() {
  ...
  Setpoint1 = analogRead(pot) / 2.26;
  int Set = map(Setpoint1, 0, 452, 0, 360);
  Input1 = encoderPos1 ;
  int Output = map(Input1, 0, 452, 0, 360);
  myPID1.Compute();
