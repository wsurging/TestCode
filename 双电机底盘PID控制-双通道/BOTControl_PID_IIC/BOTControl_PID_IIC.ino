/*************************************************************************************
   ...
   RS365 ENCODER MOTOR, 24cpr,  A and B Phase
...
#define Encoder1B  6     // 电机1B相 

#define Encoder2A  9     // 电机2A相
#define Encoder2B  8     // 电机2B相

#define maxSpeed   4096  // 速度最大值限制   0-4096
...
void setup()
{
  ...
  pinMode(Encoder2B, INPUT_PULLUP);                  // quadrature encoder2 input B
